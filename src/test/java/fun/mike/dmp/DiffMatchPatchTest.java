...
import static fun.mike.dmp.Operation.DELETE;
import static fun.mike.dmp.Operation.EQUAL;
import static fun.mike.dmp.Operation.INSERT;
...
public class DiffMatchPatchTest {
    ...
    public void testDiffCleanupSemantic() {
        ...
        dmp.diffCleanupSemantic(diffs);
        assertEquals("diffCleanupSemantic: No elimination #1.", diffList(new Diff(DELETE, "ab"), new Diff(INSERT, "cd"), new Diff(EQUAL, "12"), new Diff(DELETE, "e")), diffs);

        diffs = diffList(new Diff(DELETE, "abc"), new Diff(INSERT, "ABC"), new Diff(EQUAL, "1234"), new Diff(DELETE, "wxyz"));
        dmp.diffCleanupSemantic(diffs);
        assertEquals("diffCleanupSemantic: No elimination #2.", diffList(new Diff(DELETE, "abc"), new Diff(INSERT, "ABC"), new Diff(EQUAL, "1234"), new Diff(DELETE, "wxyz")), diffs);
        ...
        dmp.diffCleanupSemantic(diffs);
        assertEquals("diffCleanupSemantic: No overlap elimination.", diffList(new Diff(DELETE, "abcxx"), new Diff(INSERT, "xxdef")), diffs);

        diffs = diffList(new Diff(DELETE, "abcxxx"), new Diff(INSERT, "xxxdef"));
        dmp.diffCleanupSemantic(diffs);
        assertEquals("diffCleanupSemantic: Overlap elimination.", diffList(new Diff(DELETE, "abc"), new Diff(EQUAL, "xxx"), new Diff(INSERT, "def")), diffs);

        diffs = diffList(new Diff(DELETE, "xxxabc"), new Diff(INSERT, "defxxx"));
        dmp.diffCleanupSemantic(diffs);
        assertEquals("diffCleanupSemantic: Reverse overlap elimination.", diffList(new Diff(INSERT, "def"), new Diff(EQUAL, "xxx"), new Diff(DELETE, "abc")), diffs);

        diffs = diffList(new Diff(DELETE, "abcd1212"), new Diff(INSERT, "1212efghi"), new Diff(EQUAL, "----"), new Diff(DELETE, "A3"), new Diff(INSERT, "3BC"));
        dmp.diffCleanupSemantic(diffs);
        assertEquals("diffCleanupSemantic: Two overlap eliminations.", diffList(new Diff(DELETE, "abcd"), new Diff(EQUAL, "1212"), new Diff(INSERT, "efghi"), new Diff(EQUAL, "----"), new Diff(DELETE, "A"), new Diff(EQUAL, "3"), new Diff(INSERT, "BC")), diffs);
    }
    ...
    public void testDiffPrettyHtml() {
        ...
        assertEquals("diffPrettyHtml:", "<span>a&para;<br></span><del style=\"background:#ffe6e6;\">&lt;B&gt;b&lt;/B&gt;</del><ins style=\"background:#e6ffe6;\">c&amp;d</ins>", dmp.diffPrettyHtml(diffs));
    }
    ...
    public void testDiffDelta() {
        ...
        assertEquals("diff_text1: Base dmp.", "jumps over the lazy", text1);
        ...
        assertEquals("diff_text1: Unicode dmp.", "\u0680 \000 \t %\u0681 \001 \n ^", text1);
    ...
    public void testDiffMain() {
        ...
        // Increase the dmp lengths by 1024 times to ensure a timeout.
        for (int x = 0; x < 10; x++) {
            a = a + a;
            b = b + b;
        }
    ...
    public void testMatchMain() {
        ...
        assertEquals("match_main: Null dmp.", -1, dmp.match_main("", "abcdef", 1));
